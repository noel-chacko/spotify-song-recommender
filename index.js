        ...
        axios.get(options.url, { headers: options.headers })
          .then(response => {
            ...
            axios.get(recOptions.url, { headers: recOptions.headers, params: recOptions.params })
              ...
              .catch(error => {
                console.error('Error fetching recommendations:', error.response.data); // Debugging line
                res.send('Error fetching recommendations');
              });
          })
          .catch(error => {
            console.error('Error fetching top tracks:', error.response.data); // Debugging line
            res.send('Error fetching top tracks');
          });
      })
      .catch(error => {
        console.error('Error getting token:', error.response.data); // Debugging line
